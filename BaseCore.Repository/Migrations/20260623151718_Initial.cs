        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsNewsletterCoupon = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Coupons",
                columns: new[] { "Id", "Code", "DiscountType", "DiscountValue", "EndDate", "IsActive", "IsNewsletterCoupon", "MaxDiscount", "MinOrderAmount", "StartDate", "UsageLimit", "UsedCount" },
                values: new object[,]
                {
                    { 1, "AOPHONG", "Percent", 10.00m, new DateTime(2026, 5, 23, 2, 43, 0, 0, DateTimeKind.Utc), true, false, 100000.00m, 1000000.00m, new DateTime(2026, 5, 18, 2, 42, 0, 0, DateTimeKind.Utc), 5, 1 },
                    { 2, "WELCOME10", "Percent", 10.00m, new DateTime(2030, 12, 31, 23, 59, 59, 0, DateTimeKind.Utc), true, true, null, 0m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 10, "20", "Lạng Sơn", "Bắc" },
                    { 11, "4", "Cao Bằng", "Bắc" },
                    { 12, "8", "Tuyên Quang", "Bắc" },
                    { 13, "15", "Lào Cai", "Bắc" },
                    { 14, "19", "Thái Nguyên", "Bắc" },
                    { 15, "25", "Phú Thọ", "Bắc" },
                    { 16, "24", "Bắc Ninh", "Bắc" },
                    { 17, "33", "Hưng Yên", "Bắc" },
                    { 18, "37", "Ninh Bình", "Bắc" },
                    { 19, "22", "Quảng Ninh", "Bắc" },
                    { 20, "38", "Thanh Hóa", "Bắc" },
                    { 21, "40", "Nghệ An", "Trung" },
                    { 22, "42", "Hà Tĩnh", "Trung" },
                    { 23, "44", "Quảng Trị", "Trung" },
                    { 24, "51", "Quảng Ngãi", "Trung" },
                    { 25, "52", "Gia Lai", "Trung" },
                    { 26, "56", "Khánh Hòa", "Trung" },
                    { 27, "68", "Lâm Đồng", "Trung" },
                    { 28, "66", "Đắk Lắk", "Trung" },
                    { 29, "75", "Đồng Nai", "Nam" },
                    { 30, "80", "Tây Ninh", "Nam" },
                    { 31, "86", "Vĩnh Long", "Nam" },
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "BasePrice", "CategoryId", "CreatedAt", "Description", "DiscountPercent", "Name", "Slug" },
                values: new object[,]
                {
                    { 1, 290000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 500, DateTimeKind.Utc), "Áo ba lỗ nam cotton rib co giãn, form ôm vừa, thoáng mát, phù hợp tập gym hoặc mặc hàng ngày.", 0, "Áo Ba Lỗ Nam", "ao-ba-lo-nam" },
                    { 2, 290000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 503, DateTimeKind.Utc), "Áo ba lỗ nữ cotton rib mềm mại, form ôm vừa, phù hợp mặc trong hoặc layer.", 0, "Áo Ba Lỗ Nữ", "ao-ba-lo-nu" },
                    { 3, 690000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 503, DateTimeKind.Utc), "Áo gi lê nam vải tweed cao cấp, form slim, phù hợp mặc công sở hoặc dạo phố.", 0, "Áo Gi Lê Nam", "ao-gi-le-nam" },
                    { 4, 650000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 503, DateTimeKind.Utc), "Áo gi lê nữ thiết kế hiện đại, không tay, layer cùng áo sơ mi hoặc áo thun.", 0, "Áo Gi Lê Nữ", "ao-gi-le-nu" },
                    { 5, 890000.00m, 8, new DateTime(2026, 5, 14, 16, 44, 8, 506, DateTimeKind.Utc), "Blazer denim nữ oversized, vải denim mềm 11oz, phong cách casual-chic.", 0, "Áo Khoác Blazer Denim Nữ", "ao-khoac-blazer-denim-nu" },
                    { 6, 790000.00m, 1, new DateTime(2026, 5, 14, 16, 44, 8, 506, DateTimeKind.Utc), "Áo khoác bomber nam chất liệu polyester nhẹ, bo gấu rib co giãn, phong cách street.", 0, "Áo Khoác Bomber Nam", "ao-khoac-bomber-nam" },
                    { 7, 750000.00m, 8, new DateTime(2026, 5, 14, 16, 44, 8, 506, DateTimeKind.Utc), "Áo khoác cotton nữ mỏng nhẹ, không lót, phù hợp mùa xuân hè, dáng rộng thoải mái.", 0, "Áo Khoác Cotton Nữ", "ao-khoac-cotton-nu" },
                    { 8, 790000.00m, 8, new DateTime(2026, 5, 14, 16, 44, 8, 506, DateTimeKind.Utc), "Áo khoác jean nữ dáng crop, vải denim 12oz wash nhẹ, phom casual everyday.", 0, "Áo Khoác Denim Nữ", "ao-khoac-denim-nu" },
                    { 9, 390000.00m, 5, new DateTime(2026, 5, 15, 8, 38, 41, 532, DateTimeKind.Utc), "Áo kiểu cổ đổ nữ vải cotton mềm, form suông thanh lịch, phù hợp đi làm và dạo phố.", 0, "Áo Cổ Đổ Nữ", "ao-co-do-nu" },
                    { 10, 890000.00m, 1, new DateTime(2026, 5, 14, 16, 44, 8, 510, DateTimeKind.Utc), "Áo khoác linen nữ nhẹ thoáng, dáng rộng, cài cúc 3 hạt, thích hợp mùa hè.", 0, "Áo Khoác Linen Nam", "ao-khoac-linen-nam" },
                    { 11, 690000.00m, 8, new DateTime(2026, 5, 14, 16, 44, 8, 510, DateTimeKind.Utc), "Áo khoác thể thao nữ chất liệu polyester co giãn 4 chiều, thấm hút tốt.", 0, "Áo Khoác Thể Thao Nữ", "ao-khoac-the-thao-nu" },
                    { 12, 1290000.00m, 1, new DateTime(2026, 5, 14, 16, 44, 8, 510, DateTimeKind.Utc), "Áo khoác tuxedo nam vải polyester bóng, ve áo lapel satin, phong cách dự tiệc.", 0, "Áo Khoác Tuxedo Nam", "ao-khoac-tuxedo-nam" },
                    { 13, 350000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 510, DateTimeKind.Utc), "Áo kiểu nữ cổ tròn viền ren điểm nhún, vải chiffon nhẹ bay, thanh lịch.", 0, "Áo Kiểu Cổ Điểm Nhún Nữ", "ao-kieu-co-diem-nhun-nu" },
                    { 14, 490000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 510, DateTimeKind.Utc), "Áo blouse nữ pin tucked cổ đứng, vải cotton poplin, form suông chỉn chu.", 0, "Áo Pin Tucked Blouse Nữ", "ao-pin-tucked-blouse-nu" },
                    { 15, 420000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 510, DateTimeKind.Utc), "Áo sơ mi chiffon trong suốt thanh lịch, tay dài, cổ V nhẹ nhàng, phù hợp đi làm.", 0, "Áo Sơ Mi Chiffon Nữ", "ao-so-mi-chiffon-nu" },
                    { 16, 490000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 510, DateTimeKind.Utc), "Áo sơ mi nữ cổ ve đôi thanh lịch, vải lụa matte mềm rủ, phù hợp công sở.", 0, "Áo Sơ Mi Cổ 2 Ve Nữ", "ao-so-mi-co-2-ve-nu" },
                    { 17, 450000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 513, DateTimeKind.Utc), "Áo sơ mi form rộng mặc khoác, vải cotton nhẹ, phong cách unisex casual.", 0, "Áo Sơ Mi Khoác Unisex", "ao-so-mi-khoac" },
                    { 18, 550000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 513, DateTimeKind.Utc), "Áo sơ mi linen nữ thoáng mát, tay dài gập xắn được, phù hợp mùa hè và du lịch.", 0, "Áo Sơ Mi Linen Nữ", "ao-so-mi-linen-nu" },
                    { 19, 380000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 513, DateTimeKind.Utc), "Áo sơ mi nữ thắt nơ buộc eo, cổ V nhẹ, vải voile mỏng nhẹ bay bướm.", 0, "Áo Sơ Mi Nữ Buộc Dây", "ao-so-mi-nu-buoc-day" },
                    { 20, 290000.00m, 5, new DateTime(2026, 5, 14, 16, 44, 8, 513, DateTimeKind.Utc), "Áo thun nữ cotton 200gsm, cổ tròn, form boxy nhẹ nhàng, co giãn 2 chiều.", 0, "Áo Thun Nữ", "ao-thun-nu" },
                    { 21, 1590000.00m, 8, new DateTime(2026, 5, 14, 16, 44, 8, 513, DateTimeKind.Utc), "Trench coat nữ double-breasted, dây thắt eo, vải gabardine cotton, dáng dài thanh lịch.", 0, "Áo Trench Coat Nữ", "ao-trench-coat-nu" },
                    { 22, 490000.00m, 10, new DateTime(2026, 5, 14, 16, 44, 8, 513, DateTimeKind.Utc), "Chân váy đắp chéo bất đối xứng, vải lụa matte rủ đẹp, tôn dáng.", 0, "Chân Váy Đắp Chéo Nữ", "chan-vay-dap-cheo-nu" },
                    { 23, 390000.00m, 10, new DateTime(2026, 5, 14, 16, 44, 8, 516, DateTimeKind.Utc), "Chân váy jersey co giãn 2 chiều, cạp chun thoải mái, thích hợp casual đến đi làm.", 0, "Chân Váy Jersey Nữ", "chan-vay-jersey-nu" },
                    { 24, 490000.00m, 10, new DateTime(2026, 5, 14, 16, 44, 8, 516, DateTimeKind.Utc), "Chân váy maxi dài sát gót, vải thun co giãn, dáng ôm thon gọn tôn dáng.", 0, "Chân Váy Maxi Nữ", "chan-vay-maxi-nu" },
                    { 25, 450000.00m, 10, new DateTime(2026, 5, 14, 16, 44, 8, 516, DateTimeKind.Utc), "Chân váy xếp ly rủ nhẹ nhàng, lưng thun, vải chiffon mềm bay, mang nét nữ tính.", 0, "Chân Váy Xếp Rủ Nữ", "chan-vay-xep-ru-nu" },
                    { 26, 590000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 516, DateTimeKind.Utc), "Áo hoodie không tay (vest hoodie) nỉ bông, mũ 2 lớp, túi kangaroo, phong cách streetwear.", 0, "Hoodie Không Tay Nam", "hoodie-khong-tay-nam" },
                    { 27, 590000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 516, DateTimeKind.Utc), "Hoodie nỉ bông dày 380gsm, mũ 2 lớp, túi kangaroo, form oversize thoải mái.", 0, "Hoodie Nỉ Nam", "hoodie-ni-nam" },
                    { 28, 650000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 520, DateTimeKind.Utc), "Hoodie zip-up nỉ dày, khóa kéo YKK chắc chắn, tay rib, phù hợp lớp ngoài mùa lạnh.", 0, "Hoodie Khóa Kéo Nam", "hoodie-khoa-keo-nam" },
                    { 29, 550000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 520, DateTimeKind.Utc), "Áo jumper len mỏng cổ tròn, form suông nhẹ, layer tiện dụng mùa thu đông.", 0, "Jumper Nam", "jumper-nam" },
                    { 30, 490000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 520, DateTimeKind.Utc), "Áo polo nam cotton piqué 220gsm, cổ bẻ rib 3 cúc, form regular fit lịch sự.", 0, "Polo Nam", "polo-nam" },
                    { 31, 450000.00m, 6, new DateTime(2026, 5, 14, 16, 44, 8, 520, DateTimeKind.Utc), "Quần dài nữ cạp chun co giãn, vải thun lạnh mịn, form suông thoải mái.", 0, "Quần Dài Cạp Chun Nữ", "quan-dai-cap-chun-nu" },
                    { 32, 490000.00m, 6, new DateTime(2026, 5, 14, 16, 44, 8, 520, DateTimeKind.Utc), "Quần dài nam dây rút điều chỉnh eo, vải thun gió nhẹ, 2 túi sườn tiện dụng.", 0, "Quần Dài Dây Rút Nữ", "quan-dai-day-rut-nu" },
                    { 33, 590000.00m, 6, new DateTime(2026, 5, 14, 16, 44, 8, 520, DateTimeKind.Utc), "Quần satin nữ bóng mượt, cạp chun ẩn, form suông thanh lịch, thích hợp đi làm và dạ tiệc.", 0, "Quần Dài Satin Nữ", "quan-dai-satin-nu" },
                    { 34, 690000.00m, 3, new DateTime(2026, 5, 14, 16, 44, 8, 523, DateTimeKind.Utc), "Quần jean nam denim 12oz, phom slim tapered, wash nhẹ tự nhiên, 5 túi chuẩn.", 0, "Quần Jean Nam", "quan-jean-nam" },
                    { 35, 650000.00m, 6, new DateTime(2026, 5, 14, 16, 44, 8, 523, DateTimeKind.Utc), "Quần jean nữ lưng cao, denim co giãn 2 chiều, phom skinny tôn dáng.", 0, "Quần Jean Nữ", "quan-jean-nu" },
                    { 36, 690000.00m, 6, new DateTime(2026, 5, 14, 16, 44, 8, 526, DateTimeKind.Utc), "Quần jean nữ ripped knee, lưng cao, dáng skinny năng động phong cách.", 0, "Quần Jean Nữ Rách Gối", "quan-jean-nu-rach-goi" },
                    { 37, 490000.00m, 3, new DateTime(2026, 5, 14, 16, 44, 8, 526, DateTimeKind.Utc), "Quần jogger nam cotton french terry, gấu bo rib, túi zip tiện dụng, mặc gym hoặc casual.", 0, "Quần Jogger Nam", "quan-jogger-nam" },
                    { 38, 590000.00m, 6, new DateTime(2026, 5, 14, 16, 44, 8, 526, DateTimeKind.Utc), "Quần ống suông vải muslin cao cấp, nhẹ bay tự nhiên, cạp chun ẩn, phong cách boho thanh lịch.", 0, "Quần Ống Sương Muslin Nữ", "quan-ong-suong-muslin-nu" },
                    { 39, 450000.00m, 4, new DateTime(2026, 5, 14, 16, 44, 8, 526, DateTimeKind.Utc), "Quần short jean nam denim 10oz, gấu xước nhẹ, phom regular, túi hộp tiện dụng.", 0, "Quần Short Jean Nam", "quan-short-jean-nam" },
                    { 40, 390000.00m, 4, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "Quần short nỉ bông dày, cạp thun lưng, túi zip, mặc tại nhà hoặc gym thoải mái.", 0, "Quần Short Nỉ Nam", "quan-short-ni-nam" },
                    { 41, 490000.00m, 4, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "Quần short nam 4 túi hộp kiểu cargo, vải kaki dày dặn, phong cách outdoor.", 0, "Quần Short Túi Hộp Nam", "quan-short-tui-hop-nam" },
                    { 42, 690000.00m, 3, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "Quần tây nam vải polyester blend, form slim straight, li phẳng, thích hợp đi làm và sự kiện.", 0, "Quần Tây Nam", "quan-tay-nam" },
                    { 43, 690000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "Sơ mi chống nhăn vải cotton pha polyester, giữ phẳng cả ngày, phù hợp đi làm.", 0, "Sơ Mi Chống Nhăn Nam", "so-mi-chong-nhan-nam" },
                    { 44, 590000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "Sơ mi cotton 100% thoáng mát, form regular, cổ button-down, phù hợp mặc quanh năm.", 0, "Sơ Mi Cotton Nam", "so-mi-cotton-nam" },
                    { 45, 590000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "Áo sơ mi jean denim nhẹ 8oz, cổ đứng button-down, style western casual.", 0, "Sơ Mi Jean Nam", "so-mi-jean-nam" },
                    { 46, 590000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "Sweater len mịn cổ tròn, đan dệt mịn, form rộng ấm áp, phù hợp thu đông.", 0, "Áo Sweater Nam", "sweater-nam" },
                    { 47, 290000.00m, 2, new DateTime(2026, 5, 14, 16, 44, 8, 530, DateTimeKind.Utc), "T-shirt cotton 220gsm cổ tròn, form regular clean, item cơ bản không thể thiếu.", 0, "T-Shirt Nam", "tshirt-nam" },
                    { 48, 490000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 533, DateTimeKind.Utc), "Váy 2 dây xếp nếp ngực vải lụa matte mịn, dáng suông dài qua gối, nữ tính thanh lịch.", 0, "Váy 2 Dây Xếp Nếp Nữ", "vay-2-day-xep-nep-nu" },
                    { 49, 490000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 533, DateTimeKind.Utc), "Váy chiffon nữ bay nhẹ, tầng xếp nếp nhẹ nhàng, phù hợp dạo phố và sự kiện.", 0, "Váy Chiffon Nữ", "vay-chiffon-nu" },
                    { 50, 390000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 533, DateTimeKind.Utc), "Váy cotton dây rút cổ, tay phồng điểm nhún, vải co giãn nhẹ mặc thoải mái mùa hè.", 0, "Váy Dây Rút Cotton Nữ", "vay-day-rut-cotton-nu" },
                    { 51, 490000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 533, DateTimeKind.Utc), "Váy midi dáng bút chì ôm nhẹ, vải thun gân mịn, dài qua đầu gối tôn dáng.", 0, "Váy Midi Nữ", "vay-midi-nu" },
                    { 52, 590000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 533, DateTimeKind.Utc), "Váy satin bóng mượt, cổ V thanh lịch, dáng suông thân thiện với mọi vóc dáng.", 0, "Váy Satin Nữ", "vay-satin-nu" },
                    { 53, 590000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 536, DateTimeKind.Utc), "Váy sơ mi dáng shirt dress, cổ bẻ, hàng cúc ngực, thắt lưng kèm, phong cách preppy.", 0, "Váy Sơ Mi Nữ", "vay-so-mi-nu" },
                    { 54, 650000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 536, DateTimeKind.Utc), "Váy sơ mi kèm thắt lưng vải, dáng midi thắt eo tôn dáng, vải cotton nhẹ mịn.", 0, "Váy Sơ Mi Có Thắt Lưng Nữ", "vay-so-mi-co-that-lung-nu" },
                    { 55, 450000.00m, 9, new DateTime(2026, 5, 14, 16, 44, 8, 536, DateTimeKind.Utc), "Váy tunic dáng suông dài qua hông, vải linen thoáng mát, phù hợp đi biển và casual.", 0, "Váy Tunic Nữ", "vay-tunic-nu" }
                });
