...
export const FilterSidebar = ({ isOpen, onClose, updateFilters, searchParams, totalCount = 0, priceMax = 0 }) => {
  ...
  const [expanded, setExpanded] = useState({ price: true, sort: false, color: false, size: false });
  ...
  }, [isOpen, price, draftColor, draftSize, priceBound, searchParams]);
  ...
  const activeChips = useMemo(() => {
    ...
    return chips;
  }, [price, sortBy, colorId, sizeId, priceBound]);
