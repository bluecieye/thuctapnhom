...
// AUTO-GENERATED HasData blocks from sẽ.sql
            ...
            mb.Entity<Province>().HasData(
                new Province { Id = 1, Name = "Hà Nội", Code = "HN", Region = "Bắc" },
                new Province { Id = 2, Name = "Hồ Chí Minh", Code = "HCM", Region = "Nam" },
                new Province { Id = 3, Name = "Hải Phòng", Code = "HP", Region = "Bắc" },
                new Province { Id = 4, Name = "Đà Nẵng", Code = "DN", Region = "Trung" },
                new Province { Id = 5, Name = "Cần Thơ", Code = "CT", Region = "Nam" },
                new Province { Id = 6, Name = "Huế", Code = "HUE", Region = "Trung" },
                new Province { Id = 7, Name = "Lai Châu", Code = "LCH", Region = "Bắc" },
                new Province { Id = 8, Name = "Điện Biên", Code = "DB", Region = "Bắc" },
                new Province { Id = 9, Name = "Sơn La", Code = "SL", Region = "Bắc" },
                new Province { Id = 10, Name = "Lạng Sơn", Code = "LS", Region = "Bắc" },
                new Province { Id = 11, Name = "Cao Bằng", Code = "CB", Region = "Bắc" },
                new Province { Id = 12, Name = "Tuyên Quang", Code = "TQ", Region = "Bắc" },
                new Province { Id = 13, Name = "Lào Cai", Code = "LC", Region = "Bắc" },
                new Province { Id = 14, Name = "Thái Nguyên", Code = "TN", Region = "Bắc" },
                new Province { Id = 15, Name = "Phú Thọ", Code = "PT", Region = "Bắc" },
                new Province { Id = 16, Name = "Bắc Ninh", Code = "BN", Region = "Bắc" },
                new Province { Id = 17, Name = "Hưng Yên", Code = "HY", Region = "Bắc" },
                new Province { Id = 18, Name = "Ninh Bình", Code = "NB", Region = "Bắc" },
                new Province { Id = 19, Name = "Quảng Ninh", Code = "QN", Region = "Bắc" },
                new Province { Id = 20, Name = "Thanh Hóa", Code = "TH", Region = "Bắc" },
                new Province { Id = 21, Name = "Nghệ An", Code = "NA", Region = "Trung" },
                new Province { Id = 22, Name = "Hà Tĩnh", Code = "HT", Region = "Trung" },
                new Province { Id = 23, Name = "Quảng Trị", Code = "QT", Region = "Trung" },
                new Province { Id = 24, Name = "Quảng Ngãi", Code = "QNG", Region = "Trung" },
                new Province { Id = 25, Name = "Gia Lai", Code = "GL", Region = "Trung" },
                new Province { Id = 26, Name = "Khánh Hòa", Code = "KH", Region = "Trung" },
                new Province { Id = 27, Name = "Lâm Đồng", Code = "LD", Region = "Trung" },
                new Province { Id = 28, Name = "Đắk Lắk", Code = "DL", Region = "Trung" },
                new Province { Id = 29, Name = "Đồng Nai", Code = "DNA", Region = "Nam" },
                new Province { Id = 30, Name = "Tây Ninh", Code = "TNI", Region = "Nam" },
                new Province { Id = 31, Name = "Vĩnh Long", Code = "VL", Region = "Nam" },
                new Province { Id = 32, Name = "Đồng Tháp", Code = "DT", Region = "Nam" },
                new Province { Id = 33, Name = "Cà Mau", Code = "CM", Region = "Nam" },
                new Province { Id = 34, Name = "An Giang", Code = "AG", Region = "Nam" }
            );
            ...
            mb.Entity<Coupon>().HasData(
                new Coupon { Id = 1, Code = "AOPHONG", DiscountType = "Percent", DiscountValue = 10.00m, MinOrderAmount = 1000000.00m, MaxDiscount = 100000.00m, StartDate = new DateTime(2026, 5, 18, 2, 42, 0, 0, DateTimeKind.Utc), EndDate = new DateTime(2026, 5, 23, 2, 43, 0, 0, DateTimeKind.Utc), UsageLimit = 5, UsedCount = 1, IsActive = true }
            );
            ...
            // Cart: 2 rows
            mb.Entity<Cart>().HasData(
                new Cart { Id = 1, UpdatedAt = new DateTime(2026, 5, 18, 3, 55, 21, 154, DateTimeKind.Utc), UserId = 1 },
                new Cart { Id = 2, UpdatedAt = new DateTime(2026, 5, 18, 3, 54, 32, 242, DateTimeKind.Utc), UserId = 4 }
            );

            // CartItem: 1 rows
            mb.Entity<CartItem>().HasData(
                new CartItem { Id = 3, Quantity = 1, CartId = 1, VariantId = 48 }
            );

            // Order: 2 rows
            mb.Entity<Order>().HasData(
                new Order { Id = 1, Status = "Delivered", TotalAmount = 418000.00m, ShippingFee = 28000.00m, DiscountAmount = 0.00m, PaymentMethod = "COD", ShippingAddress = "a, b, c, d, e, Tuyên Quang", Note = "aa", CreatedAt = new DateTime(2026, 5, 18, 2, 42, 6, 37, DateTimeKind.Utc), EstimatedDelivery = new DateTime(2026, 5, 20, 2, 42, 6, 38, DateTimeKind.Utc), UserId = 1, CouponId = null, ShippingCarrierId = 3 },
                new Order { Id = 2, Status = "Cancelled", TotalAmount = 1080000.00m, ShippingFee = 0.00m, DiscountAmount = 100000.00m, PaymentMethod = "COD", ShippingAddress = "a, b, c, d, e, Tuyên Quang", Note = "ngon\n", CreatedAt = new DateTime(2026, 5, 18, 2, 44, 5, 506, DateTimeKind.Utc), EstimatedDelivery = new DateTime(2026, 5, 20, 2, 44, 5, 506, DateTimeKind.Utc), UserId = 1, CouponId = 1, ShippingCarrierId = 2 }
            );

            // OrderDetail: 2 rows
            mb.Entity<OrderDetail>().HasData(
                new OrderDetail { Id = 1, Quantity = 1, UnitPrice = 390000.00m, OrderId = 1, VariantId = 43 },
                new OrderDetail { Id = 2, Quantity = 2, UnitPrice = 590000.00m, OrderId = 2, VariantId = 275 }
            );
