...
namespace BaseCore.Common
{
    ...
    public static class TokenHelper
    {
        ...
        public static string HashPassword(string password, out string saltBase64)
        {
            ...
            var hashed = HashPassword(password, out byte[] saltBytes);
        ...
        public static bool IsValidPassword(string password, string saltBase64, string hashedParam)
        {
            ...
            return IsValidPassword(password, saltBytes, hashedParam);
        }
