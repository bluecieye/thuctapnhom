...
const MENU = [
  ...
  { id: 'products',   label: 'Sản phẩm',       icon: Package,      path: '/admin/products',   roles: ['Admin', 'Marketing', 'WarehouseStaff'] },
  { id: 'categories', label: 'Danh mục',        icon: ListTree,     path: '/admin/categories', roles: ['Admin', 'Marketing', 'WarehouseStaff'] },
  ...
  { id: 'images',     label: 'Ảnh sản phẩm',    icon: Image,        path: '/admin/images',      roles: ['Admin', 'Marketing', 'WarehouseStaff'] },
  { id: 'sizeguides', label: 'Bảng size',        icon: Ruler,        path: '/admin/sizeguides',  roles: ['Admin', 'WarehouseStaff'] },
