...
import { fmt, FREE_SHIP_THRESHOLD } from '../utils/format';
...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    title: 'Bán Chạy Nhất',
    subtitle: 'Những thiết kế được yêu thích nhất mùa này',
...
const QUICK_CATEGORIES = [
  { image: '/hero/tshirt.jpg', label: 'Áo',       link: '/shop?categoryIds=2,5' },
  { image: '/hero/jacket.jpg', label: 'Áo khoác', link: '/shop?categoryIds=1,8' },
  { image: '/hero/jean.jpg',   label: 'Quần',     link: '/shop?categoryIds=3,4,6,7' },
  { image: '/hero/dress.avif', label: 'Váy',      link: '/shop?categoryIds=9,10' },
];

// Thanh tiện ích / cam kết dịch vụ.
const FEATURES = [
  { icon: Truck,       title: 'Miễn phí vận chuyển', desc: `Cho đơn hàng từ ${fmt(FREE_SHIP_THRESHOLD)}đ` },
