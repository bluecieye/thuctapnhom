...
export const orderApi = {
    ...
    // Tra cứu đơn cho khách vãng lai: mã đơn + email/SĐT.
    track:        (code, contact) => api.get('/orders/track', { params: { code, contact } }),
    ...
    updateStatus: (id, status, note, trackingNumber) =>
        api.put(`/orders/${id}/status`, { status, note, trackingNumber }),
};
...
export const reviewApi = {
    ...
    uploadImage:  (formData) => api.post('/reviews/upload', formData, {
...
export const statsApi = {
    ...
    getVariantTopSales: (limit = 10) => api.get('/stats/variant-top-sales', { params: { limit } }),
};
